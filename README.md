...
- **Base de données & Auth** : [Supabase](https://supabase.com/) avec Row Level Security (RLS) et fonctions `SECURITY DEFINER`
...
4. Une fois votre URL de production Vercel obtenue (ex: `https://fyp.vercel.app`), ajoutez-la dans **Supabase Console > Authentication > URL Configuration** :
   - **Site URL** : `https://fyp.vercel.app`
   - **Redirect URLs** : `https://fyp.vercel.app/**` et `https://fyp.vercel.app/auth/callback`
